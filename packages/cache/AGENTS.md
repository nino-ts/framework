...
## Overview
Bun-native cache management for Ninots Framework

## Isolation & Decoupling
This `AGENTS.md` is strictly specific to the `@ninots/cache` package.
...
- Treat `@ninots/cache` as an independent and isolated project.
