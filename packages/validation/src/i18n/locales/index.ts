...
export const ptBR: ValidationMessages = {
	...
	after_or_equal:
		"O campo :field deve ser uma data posterior ou igual a :date.",
	alpha: "O campo :field deve conter apenas letras.",
	alpha_dash:
		"O campo :field deve conter apenas letras, números, traços e underscores.",
	alpha_dash_empty:
		"O campo :field deve conter apenas letras, números, traços e underscores.",
	...
	before_or_equal:
		"O campo :field deve ser uma data anterior ou igual a :date.",
	...
	missing_unless:
		"O campo :field deve estar ausente a menos que :other seja :value.",
	missing_with:
		"O campo :field deve estar ausente quando :values está presente.",
	missing_with_all:
		"O campo :field deve estar ausente quando :values estão presentes.",
	...
	present_unless:
		"O campo :field deve estar presente a menos que :other seja :value.",
	prohibited_if: "O campo :field é proibido quando :other é :value.",
	prohibited_unless:
		"O campo :field é proibido a menos que :other seja :value.",
	...
	required_unless:
		"O campo :field é obrigatório a menos que :other seja :value.",
	required_with: "O campo :field é obrigatório quando :values está presente.",
	required_without:
		"O campo :field é obrigatório quando :values não está presente.",
...
export const en: ValidationMessages = {
	...
	missing_with_all:
		"The :field field must be missing when :values are present.",
...
export const es: ValidationMessages = {
	...
	after_or_equal:
		"El campo :field debe ser una fecha posterior o igual a :date.",
	...
	before_or_equal:
		"El campo :field debe ser una fecha anterior o igual a :date.",
	...
	missing_unless:
		"El campo :field debe estar ausente a menos que :other sea :value.",
	missing_with:
		"El campo :field debe estar ausente cuando :values está presente.",
	missing_with_all:
		"El campo :field debe estar ausente cuando :values están presentes.",
	...
	present_unless:
		"El campo :field debe estar presente a menos que :other sea :value.",
	prohibited_if: "El campo :field está prohibido cuando :other es :value.",
	prohibited_unless:
		"El campo :field está prohibido a menos que :other sea :value.",
	...
	required_unless:
		"El campo :field es obligatorio a menos que :other sea :value.",
	required_with: "El campo :field es obligatorio cuando :values está presente.",
	required_without:
		"El campo :field es obligatorio cuando :values no está presente.",
