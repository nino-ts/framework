	...
	implements StandardSchemaV1<TInput, TOutput>
{
	...
	public validate(
		...
		| StandardSchemaSuccessResult<TOutput>
		| StandardSchemaFailureResult<TInput> {
	 ...
	 */
	protected validateNullability(
		value: unknown,
	): { success: true } | { success: false; issue: StandardSchemaIssue } {
