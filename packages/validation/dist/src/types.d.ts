 ...
 */
export type StandardSchemaValidateAsync<T = unknown, U = T> = (value: T) => Promise<StandardSchemaSuccessResult<U> | StandardSchemaFailureResult<T>>;
/**
 ...
 */
export type StandardSchemaValidateSync<T = unknown, U = T> = (value: T) => StandardSchemaSuccessResult<U> | StandardSchemaFailureResult<T>;
/**
