 ...
 */
export declare function object<T extends Record<string, StandardSchemaV1>>(shape: T): ObjectSchema<T>;
/**
 ...
 */
export declare function obj<T extends Record<string, StandardSchemaV1>>(shape: T): ObjectSchema<T>;
