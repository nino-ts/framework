...
## Overview
Configuration management with lazy loading for Bun

## Isolation & Decoupling
This `AGENTS.md` is strictly specific to the `@ninots/config` package.
...
- Treat `@ninots/config` as an independent and isolated project.
