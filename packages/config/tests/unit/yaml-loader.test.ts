...
- item2`;
    ...
    test('should throw if YAML root is string', async () => {
      const loader = new YamlLoader();
      const filePath = join(testDir, 'string.yaml');
    ...
    test('should throw if YAML root is null', async () => {
      const loader = new YamlLoader();
    ...
    test('should load empty YAML with whitespace only', async () => {
      const loader = new YamlLoader();
      const filePath = join(testDir, 'whitespace.yaml');
