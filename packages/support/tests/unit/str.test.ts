	...
	describe("Manipulation", () => {
		describe("replace", () => {
			it("replaces all occurrences", () => {
				expect(Str.replace("hello hello hello", "hello", "hi")).toBe(
					"hi hi hi",
				);
			});
		...
		describe("replaceFirst", () => {
			it("replaces only the first occurrence", () => {
				expect(Str.replaceFirst("hello hello hello", "hello", "hi")).toBe(
					"hi hello hello",
				);
			});

			it("returns unchanged if search not found", () => {
				expect(Str.replaceFirst("hello world", "xyz", "test")).toBe(
					"hello world",
				);
			});
