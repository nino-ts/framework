...
type RouteCallArgs<Name extends RegistryName> = HasNoParams<Name> extends true ? [] | [ParamsOf<Name>?] : [ParamsOf<Name>];
/**
 ...
 */
export declare function setRouteResolver(router: RouteResolver): void;
/**
 ...
 */
export declare function route<Name extends RegistryName>(name: Name, ...args: RouteCallArgs<Name>): string;
export {};
