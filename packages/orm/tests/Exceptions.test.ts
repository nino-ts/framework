...
import { MassAssignmentException, ModelNotFoundException, QueryException, RelationNotFoundException } from '@/exceptions';
    ...
    describe('MassAssignmentException', () => {
        test('should format message with model and keys', () => {
            ...
            expect(error.message).toBe(
                'Add [password, role] to fillable property to allow mass assignment on [User].'
            );
