...
type CastsConstructor<TBase extends ObjectConstructor> = new (...args: ConstructorParameters<TBase>) => InstanceType<TBase> & CastsAttributes;
export declare function withCasts<TBase extends ObjectConstructor>(Base: TBase): TBase & CastsConstructor<TBase>;
export {};
