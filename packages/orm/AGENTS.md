...
## Overview
Eloquent-like ORM for Bun built with native features - Standalone package

## Isolation & Decoupling
This `AGENTS.md` is strictly specific to the `@ninots/orm` package.
...
- Treat `@ninots/orm` as an independent and isolated project.
