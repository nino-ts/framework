...
export type ViewComponent<P extends Record<string, unknown> = Record<string, unknown>> = (props: P) => ViewResult;
export type LayoutComponent<P extends Record<string, unknown> = Record<string, unknown>> = (props: P & {
    children: string;
}) => ViewResult;
