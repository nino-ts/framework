 ...
 * ```
 */
export declare class S3Adapter implements FilesystemDisk {
    private client;
    private root;
    private defaultAcl?;
     ...
     */
    getVisibility(_path: string): Promise<"public" | "private" | null>;
    /**
     ...
     * @returns True on success, false on failure
     */
    setVisibility(_path: string, _visibility: "public" | "private"): Promise<boolean>;
    /**
     ...
     */
    temporaryUploadUrl(path: string, expiresIn: number, options?: {
        contentType?: string;
     ...
     * @returns True on success, false on failure
     */
    putWithProgress(path: string, contents: Blob | Uint8Array, onProgress: (percent: number) => void): Promise<boolean>;
    /**
